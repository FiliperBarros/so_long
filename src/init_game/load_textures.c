...
/*   Updated: 2025/09/22 19:15:41 by frocha-b         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_textures(t_game *g)
{
	...
	g->player_img[0].img = mlx_xpm_file_to_image(g->mlx, P_L_XPM, &g->x, &g->y);
	g->player_img[1].img = mlx_xpm_file_to_image(g->mlx, P_R_XPM, &g->x, &g->y);
	g->player_img[2].img = mlx_xpm_file_to_image(g->mlx, P_U_XPM, &g->x, &g->y);
	if (!g->wall_img.img || !g->floor_img.img || !g->exit_img.img
		|| !g->coltbl_img.img || !g->player_img[0].img || !g->player_img[1].img
		|| !g->player_img[2].img)
